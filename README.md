...
El código fuente completo se encuentra en la carpeta `/app`. Por motivos de ciberseguridad, el archivo `google-services.json` de Firebase ha sido excluido del repositorio público mediante `.gitignore`.